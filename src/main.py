"""Main module for the Minecraft Mobs game."""
    ...
    def __init__(self) -> None:
        ...
        try:
            self.font: pygame.font.Font = pygame.font.Font(
                "data/fonts/default.otf", int(FONT_SIZE)
            )
    ...
    def render_text(self) -> None:
        ...
        if Game.GAME:
            ...
            text_area_rect = pygame.Rect(
                0, GRID_HEIGHT, GRID_WIDTH, int(TEXTAREA_HEIGHT)
            )
            ...
            for line in text_lines:
                if line.strip():  # Only render non-empty lines
                    ...
                    self.screen.blit(
                        text_surface, (int(TEXTAREA_HORIZONTAL_MARGIN), y_offset)
                    )
